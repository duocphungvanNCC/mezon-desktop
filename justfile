...
pkgs := "-p mezon-app -p mezon-ui -p mezon-store -p mezon-client -p mezon-native -p mezon-proto -p mezon-i18n -p mezon-theme -p mezon-widgets -p mezon-canvas -p mezon-updater -p mezon-audio -p mezon-cli -p mezon-mcp -p mezon-voice -p mezon-stream -p mmn-client"
